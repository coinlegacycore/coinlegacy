...
//////////////////////////////////////
#include <LegacyWallet/LegacyWallet.h>
//////////////////////////////////////
...
#include <LegacyWallet/Commands.h>
#include <LegacyWallet/Fusion.h>
#include <LegacyWallet/Open.h>
#include <LegacyWallet/ParseArguments.h>
#include <LegacyWallet/Sync.h>
#include <LegacyWallet/Transfer.h>
#include <LegacyWallet/Tools.h>
...
{
    /* On ctrl+c the program seems to throw "legacywallet.exe has stopped
    ...
    Logging::LoggerRef logger(logManager, "legacywallet");
         ...
         Config &config)
{
    ...
    do
    {
        std::cout << InformationMsg("Coinlegacy v"
                                  + std::string(PROJECT_VERSION)
                                  + " Legacywallet") << std::endl;
    ...
    {
        std::cout << WarningMsg("It looks like Coinlegacyd isn't open!")
                  << std::endl << std::endl
                  << WarningMsg("Ensure Coinlegacyd is open and has finished "
                                "initializing.")
                  << std::endl
                  << WarningMsg("If it's still not working, try restarting "
                                "Coinlegacyd. The daemon sometimes gets stuck.") 
                  << std::endl
                  << WarningMsg("Alternatively, perhaps Coinlegacyd can't "
              ...
              bool &alreadyShuttingDown)
{
    ...
    {
        std::cout << "Wait, we're already shutting down!" 
                  << std::endl;
        return false;
    }
    else
